...
export default function Home() {
  ...
  return (
    <div className=" bg-[#0c0c0b] text-white px-6 md:px-16 py-10 flex items-center justify-center">
      <div className="grid md:grid-cols-2 items-center justify-items-center gap-5">
        <div className="flex flex-col">
          <div className="flex items-center  gap-5">
            <p className="text-9xl font-pixel-grid">Iniyan V</p>
        ...
        <Image src="/me.png" width={400} height={400} priority alt="profile" />
      </div>
    </div>
  );
}
